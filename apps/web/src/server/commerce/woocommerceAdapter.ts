/**
 * WooCommerce Commerce Adapter (Milestone C2, C19)
 *
 * Interacts with WooCommerce Store API endpoints.
 */
...
export class WooCommerceCommerceAdapter implements CommerceAdapter {
