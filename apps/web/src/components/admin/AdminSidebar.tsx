...
const Icon = ({ type }: { type: string }) => {
  switch (type) {
    ...
    case "globe":           return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>;
...
const navItems = [
  ...
  { section: "Monitoring", items: [{ label: "Live Conversations", href: "/admin/conversations", icon: "conversations" }, { label: "Usage", href: "/admin/usage", icon: "usage" }, { label: "Infrastructure", href: "/admin/infrastructure", icon: "infrastructure" }] },
    { section: "Data", items: [{ label: "Products", href: "/admin/products", icon: "products" }, { label: "Knowledge", href: "/admin/knowledge", icon: "knowledge" }, { label: "Website Registry", href: "/admin/website-registry", icon: "globe" }] },
