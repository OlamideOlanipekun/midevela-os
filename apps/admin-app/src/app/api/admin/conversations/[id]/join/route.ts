...
import { joinConversation } from "@/lib/conversations/service";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    await joinConversation(id, admin.sub);
    broadcastConversationEvent({ type: "human.joined", conversationId: id });
